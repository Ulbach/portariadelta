...
/**
 * NOME DA ABA DEFINITIVO: Dados
 * Esta aba é onde o Apps Script deve ler e gravar os registros.
 */
export const DATA_TAB_NAME: string = 'Dados'; 

// Link do Apps Script do usuário
export const SCRIPT_URL: string = import.meta.env.VITE_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbxT3kzlOYTIDGXbmN9Yd6IQc2p_TUf6YZztg6-WRb5acLrUBrm7VyqUyC9pW0m9zycwNg/exec'; 

// Empresas iniciais (serão sobrescritas pelas abas reais da planilha)
export const INITIAL_COMPANIES = ['TecmiSul', 'HBR', 'MAX'];
...
export const ICONS = {
  ...
  LogIn: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 5 12 10 7"/><line x1="15" y1="12" x2="5" y2="12"/></svg>
  ),
  Search: (props: any) => (
